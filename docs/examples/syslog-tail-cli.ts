 ...
 * 
 * Usage:
 *   tsx syslog-tail-cli.ts --instance your-instance
 *   tsx syslog-tail-cli.ts --instance your-instance --level error
 *   tsx syslog-tail-cli.ts --instance your-instance --output ./logs/tail.log
 *   tsx syslog-tail-cli.ts --instance your-instance --table syslog_app_scope --query "app_scope=x_my_app"
 * 
 * Alternative (after building):
 *   node --loader ts-node/esm syslog-tail-cli.ts --instance your-instance
 */
...
// Configuration
const instanceAlias = options.instance || 'your-instance';
