...
```bash
# All logs
node docs/examples/syslog-tail.mjs your-instance
...
node docs/examples/syslog-tail.mjs your-instance warn ./logs/warnings.log 3000
```
...
Then run:
```bash
tsx docs/examples/syslog-tail-cli.ts --instance your-instance --level error
```
...
# Save to file
node docs/examples/syslog-tail.mjs your-instance error ./errors.log

# Fast polling (every 2 seconds)
node docs/examples/syslog-tail.mjs your-instance all ./all-logs.log 2000
```
...
**Examples:**
```bash
tsx docs/examples/syslog-tail-cli.ts --instance your-instance
tsx docs/examples/syslog-tail-cli.ts --instance your-instance --level error
tsx docs/examples/syslog-tail-cli.ts --instance your-instance --query "sourceSTARTSWITHsecurity"
tsx docs/examples/syslog-tail-cli.ts --instance your-instance --output ./logs/tail.log
```
