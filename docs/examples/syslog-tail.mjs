 ...
 *   node syslog-tail.mjs your-instance error
 *   node syslog-tail.mjs your-instance error ./logs/tail.log
 *   node syslog-tail.mjs your-instance all ./logs/all.log 3000
 * 
 * Arguments:
...
if (!instanceAlias) {
    ...
    console.error('Example: node syslog-tail.mjs your-instance error ./logs/errors.log 3000');
    process.exit(1);
}
