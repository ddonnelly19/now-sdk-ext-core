 ...
 * 
 * Usage:
 *   node syslog-tail-channel.mjs your-instance
 *   node syslog-tail-channel.mjs your-instance ./logs/tail.log
 *   node syslog-tail-channel.mjs your-instance ./logs/tail.log 1000
 * 
 * Arguments:
...
if (!instanceAlias) {
    ...
    console.error('Example: node syslog-tail-channel.mjs your-instance ./logs/tail.log 1000');
    process.exit(1);
}
